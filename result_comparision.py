...
class result_comparison:
    ...
    def plot_comparison(self, comp_type):
        ...
        temp_f.write("set terminal pngcairo noenhanced size 1024,600 font 'Ubuntu,10'\n")
        ...
        temp_f.write("set terminal wxt noenhanced font 'Ubuntu,10'\n")
        temp_f.close()
    ...
    def plot_schedstats_pie_chart(self, name):
        ...
        temp_f.write("set output '"+ name + ".png'\n")
        ...
        os.system('gnuplot -e "filename=\'' + name + '.txt' + '\''+'" /tmp/plot_schedstats_pie_chart_template')
    ...
    def plot_schedstats_comparison(self, name):
        ...
        temp_f.write("set output '"+ name + "_comparison.png'\n")
        ...
        temp_f.close()
        os.system('gnuplot -e "filename=\'' + name + '.txt' + '\''+'" /tmp/plot_schedstats_comparison_template')
    ...
    def parse_sched_scenarios(self, scenarios, comp_str):
        ...
        for s in scenarios:
            ...
            self.fo = open(comp_str + '_' + s + '.txt', "w+")
            ...
            for kern in self.sections:
                ...
                self.sis_fo = open(comp_str + '_' + kern + '_' + s + '_sis.txt', "w+")
                ...
                self.secb_fo = open(comp_str + '_' + kern + '_' + s + '_secb.txt', "w+")
                ...
                self.fbt_fo = open(comp_str + '_' + kern + '_' + s + '_fbt.txt', "w+")
